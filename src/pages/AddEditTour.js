...
const AddEditTour = () => {
 ...
 {
  window.location.href = 'https://sketchmate.vercel.app/sketchwithai';
 }
        ...
        <MDBCardBody>
          <MDBValidation onSubmit={handleSubmit} className="row g-3" noValidate>
            ...
            <button type="button"   className="btn btn-warning btn-rounded" onClick ={handlestar}><i className="fas fa-paint-brush"></i>   Draw Own Sketch</button>
               ...
               <div>or</div>
            <button type="button"   className="btn btn-info btn-rounded" onClick ={handlebeautify}> 🤖  Sketch with  AI </button>
            <div>or</div>
